	...
	<view class="uni-padding-wrap">
      ...
      <view v-if="false && 1 == 1" class="idea recommendIdea" :style='{"padding":"20rpx 10rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"20rpx 0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","background":"rgba(0,0,0,.3)","width":"100%","borderStyle":"solid","height":"auto"}'>
      	...
      	<view class="box box4"></view>
			...
			<view class="title" :style='{"padding":"0 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"20rpx 0 0 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0, 186, 189, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"80rpx"}'>
				<view :style='{"padding":"0 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(130, 163, 157, 1)","backgroundColor":"rgba(130, 163, 157, 0.34)","color":"#FFF","textAlign":"left","borderRadius":"0","borderWidth":"0 0 0 8rpx","width":"auto","fontSize":"32rpx","lineHeight":"80rpx","borderStyle":"solid"}'>电影信息推荐</view>
			</view>
      ...
      <view v-if="5 == 5" class="list-box style5" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"20rpx auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"95%","borderStyle":"solid","height":"300rpx"}'>
        <swiper circular display-multiple-items="3" class="swiper" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"20rpx auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"95%","borderStyle":"solid","height":"300rpx"}'>
          <swiper-item @tap="onDetailTap('dianyingxinxi',product.id)" v-for="(product,index) in dianyingxinxilist" :key="index" class="swiper-item" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 10rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0.56)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"300rpx"}'>
                                                <view :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","borderStyle":"solid"}'>{{product.dianyingmingcheng}}</view>
                                                                                    <image :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"244rpx"}' class="list-item-image" mode="aspectFill" :src="product.dianyinghaibao?baseUrl+product.dianyinghaibao.split(',')[0]:''"></image>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          </swiper-item>
        </swiper>
      </view>
      ...
      <view v-if="false && 1 == 1" class="idea recommendIdea" :style='{"padding":"20rpx 10rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"20rpx 0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","background":"rgba(0,0,0,.3)","width":"100%","borderStyle":"solid","height":"auto"}'>
      	...
      	<view class="box box4"></view>
			...
			<view class="title" :style='{"padding":"0 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"20rpx 0 0 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0, 186, 189, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"80rpx"}'>
				<view :style='{"padding":"0 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(130, 163, 157, 1)","backgroundColor":"rgba(130, 163, 157, 0.34)","color":"#FFF","textAlign":"left","borderRadius":"0","borderWidth":"0 0 0 8rpx","width":"auto","fontSize":"32rpx","lineHeight":"80rpx","borderStyle":"solid"}'>最新资讯推荐</view>
			</view>
      <view v-if="false && 1 == 2" class="idea recommendIdea" :style='{"padding":"20rpx 10rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"20rpx 0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","background":"rgba(0,0,0,.3)","width":"100%","borderStyle":"solid","height":"auto"}'>
      	<view class="box box1"></view>
      	<view class="box box2"></view>
      ...
      <view v-if="5 == 5" class="list-box style5" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"20rpx auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"95%","borderStyle":"solid","height":"300rpx"}'>
        <swiper circular display-multiple-items="3" class="swiper" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"20rpx auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"95%","borderStyle":"solid","height":"300rpx"}'>
          <swiper-item @tap="onDetailTap('zuixinzixun',product.id)" v-for="(product,index) in zuixinzixunlist" :key="index" class="swiper-item" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 10rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0.56)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"300rpx"}'>
...
<script>
	...
	export default {
		...
		async onShow() {
			...
			// 推荐信息
			res = await this.$api.recommend('dianyingxinxi', {                                              
                page: 1,
                limit: 4
            });
			this.dianyingxinxilist = res.data.list
			// 推荐信息
			res = await this.$api.recommend('zuixinzixun', {                                              
                page: 1,
                limit: 4
            });
			this.zuixinzixunlist = res.data.list
